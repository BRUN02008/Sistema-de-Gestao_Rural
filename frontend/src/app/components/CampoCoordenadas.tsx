...
export default function CampoCoordenadas({ dados, onChange }: CampoCoordenadasProps) {
  ...
  }, [dados.latitude, dados.tipoCoordenada, conversaoAutomatica]);
  ...
  }, [dados.longitude, dados.tipoCoordenada, conversaoAutomatica]);

  // Quando mudar coordenadas geográficas, atualizar decimal
  useEffect(() => {
    if (conversaoAutomatica && dados.tipoCoordenada === "geografica") {
      if (dados.latitudeGraus && dados.latitudeMinutos && dados.latitudeSegundos && dados.latitudeDirecao) {
      ...
      if (dados.longitudeGraus && dados.longitudeMinutos && dados.longitudeSegundos && dados.longitudeDirecao) {
    ...
    <div className="space-y-5">
      ...
      {dados.latitude && dados.longitude && obterLinkMapa() && (
        <a
          ...
          className="flex items-center justify-center gap-2 w-full px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all shadow-lg font-semibold"
        >
